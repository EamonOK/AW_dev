...
$Event(0, Default, function() {
    ...
    $InitializeEvent(0, 705);
    $InitializeEvent(0, 900);
    $InitializeEvent(0, 901);
    $InitializeEvent(0, 902);
    $InitializeEvent(0, 910);
    $InitializeEvent(0, 916);
    $InitializeEvent(0, 1040);
    $InitializeEvent(0, 1030);
    $InitializeEvent(0, 1050);
    ...
    $InitializeEvent(0, 936, 60490000, 60490001, 1049532500, 60495300, 1049532500, 63003, false, Weather.Default, -1);
    $InitializeEvent(1, 936, 60490020, 60490021, 1049532504, 60485400, 1049532504, 63003, false, Weather.Default, -1);
    $InitializeEvent(0, 970);
    $InitializeEvent(0, 9820, 8820, 4820, 3600);
    $InitializeEvent(0, 1020);
    InitializeEvent(0, 9945, 0);
    $InitializeEvent(0, 1400);
    $InitializeEvent(0, 1401);
    ...
    $InitializeEvent(0, 1402);
    $InitializeEvent(0, 1403);
    $InitializeEvent(0, 1420);
    $InitializeEvent(0, 1070);
    ...
    $InitializeEvent(0, 945);
    $InitializeEvent(0, 920);
    $InitializeEvent(0, 921);
    $InitializeEvent(0, 922);
    ...
    $InitializeEvent(0, 1800);
    $InitializeEvent(0, 1801);
    ...
    $InitializeEvent(0, 1460);
    $InitializeEvent(0, 1461);
    $InitializeEvent(0, 1462);
    $InitializeEvent(0, 1700);
    $InitializeEvent(0, 1701);
    $InitializeEvent(0, 1703);
    $InitializeEvent(0, 1704);
    $InitializeEvent(0, 1705);
    $InitializeEvent(0, 1750);
    $InitializeEvent(0, 1751);
    $InitializeEvent(0, 1752);
    $InitializeEvent(0, 1706);
    $InitializeEvent(0, 1707);
    $InitializeEvent(0, 1708);
    ...
    $InitializeEvent(97, 1200, 9297, 2008038, 0, 520777); // boss reward AWx
    ...
    $InitializeEvent(0, 1080);
    $InitializeEvent(0, 1088);
    $InitializeEvent(0, 841);
    $InitializeEvent(0, 9910, 3005);
    $InitializeEvent(0, 750);
...
$Event(50, Default, function() {
    ...
    $InitializeEvent(0, 715);
    $InitializeEvent(0, 716);
    $InitializeEvent(0, 717);
    SetEventFlagID(6000, OFF);
    SetEventFlagID(6001, ON);
    SetEventFlagID(9000, OFF);
    SetEventFlagID(9001, OFF);
    SetEventFlagID(280, OFF);
    $InitializeEvent(0, 740);
    $InitializeEvent(0, 810);
    $InitializeEvent(0, 820, 550, Weather.Cloudless);
    $InitializeEvent(1, 820, 551, Weather.Default);
    $InitializeEvent(2, 820, 552, Weather.FlatClouds);
    $InitializeEvent(3, 820, 553, Weather.PuffyClouds);
    $InitializeEvent(4, 820, 554, Weather.Rain);
    $InitializeEvent(5, 820, 555, Weather.RainyClouds);
    $InitializeEvent(6, 820, 556, Weather.WindyRain);
    $InitializeEvent(7, 820, 557, Weather.WindyFog);
    $InitializeEvent(8, 820, 558, Weather.Snow);
    $InitializeEvent(9, 820, 559, Weather.HeavySnow);
    $InitializeEvent(10, 820, 560, Weather.Fog);
    $InitializeEvent(11, 820, 561, Weather.HeavyFog);
    $InitializeEvent(12, 820, 562, Weather.RainyHeavyFog);
    $InitializeEvent(13, 820, 563, Weather.WindyPuffyClouds);
    $InitializeEvent(0, 839);
    $InitializeEvent(0, 840);
    $InitializeEvent(0, 980);
    SetEventFlagID(909, OFF);
    $InitializeEvent(0, 3040);
    $InitializeEvent(0, 9440);
    $InitializeEvent(0, 3041);
    $InitializeEvent(0, 3042);
    $InitializeEvent(0, 3043);
    $InitializeEvent(0, 3044);
    $InitializeEvent(0, 3045);
    $InitializeEvent(0, 3046);
    $InitializeEvent(0, 3056);
    $InitializeEvent(0, 3080);
    if (!EventFlag(2052)) {
        $InitializeEvent(0, 3179);
        $InitializeEvent(0, 3499);
        $InitializeEvent(0, 3659);
        $InitializeEvent(0, 3239);
        $InitializeEvent(0, 3619);
        $InitializeEvent(0, 3559);
        $InitializeEvent(0, 3679);
        $InitializeEvent(0, 3959);
        $InitializeEvent(0, 3779);
        $InitializeEvent(0, 3839);
        $InitializeEvent(0, 3859);
        $InitializeEvent(0, 4119);
        $InitializeEvent(0, 3119);
        $InitializeEvent(0, 3199);
        $InitializeEvent(0, 3279);
        $InitializeEvent(0, 3299);
        $InitializeEvent(0, 3579);
        $InitializeEvent(0, 3699);
        $InitializeEvent(0, 3399);
        $InitializeEvent(0, 3419);
        $InitializeEvent(0, 3379);
        $InitializeEvent(0, 3439);
        $InitializeEvent(0, 3459);
        $InitializeEvent(0, 3479);
        $InitializeEvent(0, 3639);
        $InitializeEvent(0, 3719);
        $InitializeEvent(0, 3599);
        $InitializeEvent(0, 4259);
        $InitializeEvent(0, 3979);
        $InitializeEvent(0, 3919);
        $InitializeEvent(0, 3899);
        $InitializeEvent(0, 3739);
        $InitializeEvent(0, 4159);
        $InitializeEvent(0, 3799);
        $InitializeEvent(0, 3819);
        $InitializeEvent(0, 4239);
        $InitializeEvent(0, 3879);
        $InitializeEvent(0, 4199);
        $InitializeEvent(0, 4179);
        $InitializeEvent(0, 4219);
        $InitializeEvent(0, 4719);
        $InitializeEvent(0, 4739);
        $InitializeEvent(0, 4059);
        $InitializeEvent(0, 4139);
        $InitializeEvent(0, 4079);
        $InitializeEvent(0, 3759);
        $InitializeEvent(0, 4279);
        $InitializeEvent(0, 4299);
        $InitializeEvent(0, 4319);
        $InitializeEvent(0, 4339);
        $InitializeEvent(0, 4359);
        $InitializeEvent(0, 4379);
        $InitializeEvent(0, 4399);
        $InitializeEvent(0, 4419);
        $InitializeEvent(0, 4439);
        $InitializeEvent(0, 4459);
        $InitializeEvent(0, 4479);
        $InitializeEvent(0, 4499);
        $InitializeEvent(0, 4519);
        $InitializeEvent(0, 4579);
    }
    $InitializeEvent(0, 3049);
    $InitializeEvent(0, 3050);
    $InitializeEvent(0, 3051);
    $InitializeEvent(0, 3052);
    $InitializeEvent(0, 3053);
    $InitializeEvent(0, 3054);
    $InitializeEvent(0, 3055);
    $InitializeEvent(0, 3058);
    $InitializeEvent(0, 3059);
    $InitializeEvent(0, 3089);
    $InitializeEvent(0, 4612);
    ...
    $InitializeEvent(0, 3098);
    $InitializeEvent(0, 3099);
    ...
    $InitializeEvent(0, 4844);
    $InitializeEvent(0, 4845, 2046429211, 4365, 2046429209, 2046420700, 30, 2046422707, 2048459221, 4366, 2048459215, 2048450700, 2048452707, 1030000, 1030001);
    ...
    $InitializeEvent(0, 4854, 2051459246, 4505, 2051459243, 2051450710, 30, 2051452715, 1030010);
    $InitializeEvent(1, 4854, 2051459208, 4505, 2051459244, 2051450710, 30, 2051452716, 1030011);
    $InitializeEvent(2, 4854, 2051459247, 4505, 2051459245, 2051450710, 30, 2051452717, 1030012);
...
L0:
    ...
    $InitializeEvent(0, 6901);
    $InitializeEvent(0, 6902);
    $InitializeEvent(0, 6903);
    $InitializeEvent(0, 6904);
    $InitializeEvent(0, 6905);
    $InitializeEvent(0, 6906);
    $InitializeEvent(0, 6907);
    $InitializeEvent(0, 6908);
    $InitializeEvent(0, 6909);
    $InitializeEvent(0, 6910);
    EndEvent();
});

// レガシー到達チェック_XX -- Legacy achievement check_XX
$Event(130, Default, function(hitEntityId) {
    EndIf(ThisEventSlot());
    WaitFor(PlayerIsInOwnWorld() && PlayerStandingOnHit(hitEntityId));
    SetThisEventSlot(ON);
});

// ゲーム開始フラグ操作 -- Game start flag operation
...
// ゲーム開始固定状況解除 -- Fixed game start status canceled
...
// ゲーム開始時間固定 -- Fixed game start time
...
// ホストがマルチプレイかの判定 -- Determining whether the host is multiplayer
...
// レガシー／オープン判定 -- Legacy/Open Judgment
...
// レガシー／オープン判定（データ） -- Legacy/open judgment (data)
...
// 大ルーン解放数チェック_XX -- Check number of large runes released_XX
$Event(720, Restart, function(eventFlagId, countThreshold) {
    EndIf(EventFlag(eventFlagId));
    WaitFor(
        PlayerIsInOwnWorld()
            && CountEventFlags(TargetEventFlagType.EventFlag, 190, 199) >= countThreshold);
    SetEventFlagID(eventFlagId, ON);
});

// 大ルーン所持数チェック_XX -- Check number of large runes in possession_XX
$Event(730, Restart, function(eventFlagId, countThreshold) {
    EndIf(EventFlag(eventFlagId));
    WaitFor(
        PlayerIsInOwnWorld()
            && CountEventFlags(TargetEventFlagType.EventFlag, 170, 179) >= countThreshold);
    SetEventFlagID(eventFlagId, ON);
});

// カメラパラムリセット -- Camera param reset
$Event(740, Default, function() {
    DisableNetworkSync();
    ChangeCamera(-1, -1);
});

// 円形サークル撃破後帰還アニメ -- Return animation after defeating the circular circle
...
// 時間帯監視イベント -- Time zone monitoring event
...
// 天候監視イベント_XX -- Weather monitoring event_XX
$Event(820, Default, function(eventFlagId, weather) {
    DisableNetworkSync();
...
// 天候監視イベント_系列 -- Weather monitoring event_series
...
// 天候変化_リセット -- Weather change_reset
...
// 天変地異_世界樹炎上 -- Natural disaster_World tree in flames
...
// 天変地異_メリナ炎上 -- Natural disaster_Melina goes up in flames
...
// 天変地異_メリナ炎上_救済 -- Natural disaster_Melina in flames_Relief
...
// 天変地異_巨星墜つ -- Natural disaster_Giant star falls
...
// 狂い火抑え_使用完了 -- Crazy fire suppression_Used completed
...
// 巨大エレベータ起動_XX -- Giant elevator starts_XX
$Event(930, Default, function(cutsceneId, cutsceneId2, entityId, actionButtonParameterId, itemId, itemId2, mapId, areaEntityId, areaEntityId2, unknown) {
    onlineItemAct &= !(HasMultiplayerState(MultiplayerState.Multiplayer)
        || HasMultiplayerState(MultiplayerState.MultiplayerPending))
        && PlayerIsInOwnWorld();
    if (Signed(itemId) != 0) {
        onlineItemAct &= PlayerHasItem(ItemType.Goods, itemId);
    }
    if (Signed(itemId2) != 0) {
        onlineItemAct &= PlayerHasItem(ItemType.Goods, itemId2);
    }
    onlineItemAct &= ActionButtonInArea(actionButtonParameterId, entityId);
    WaitFor(onlineItemAct);
    SetEventFlagID(9021, ON);
    PlayCutsceneToPlayerAndWarp(cutsceneId, CutscenePlayMode.Skippable, areaEntityId, mapId, 10000, unknown, false);
    WaitFixedTimeRealFrames(1);
    PlayCutsceneToPlayer(cutsceneId2, CutscenePlayMode.SkippableWithFadeOutSkip, 10000);
    WaitFixedTimeRealFrames(1);
    RestartEvent();
    if (PlayerIsInOwnWorld()) {
        PlayCutsceneToPlayerAndWarp(cutsceneId, CutscenePlayMode.Skippable, areaEntityId, mapId, 10000, 0, false);
    } else if (areaEntityId2 != 0) {
        PlayCutsceneToPlayerAndWarp(cutsceneId, CutscenePlayMode.Skippable, areaEntityId2, mapId, 10000, 0, false);
    } else {
        PlayCutsceneToPlayerAndWarp(cutsceneId, CutscenePlayMode.Skippable, areaEntityId, mapId, 10000, 0, false);
    }
    WaitFixedTimeRealFrames(1);
    if (PlayerIsInOwnWorld()) {
        PlayCutsceneToPlayerAndWarp(cutsceneId2, CutscenePlayMode.SkippableWithFadeOutSkip, areaEntityId, mapId, 10000, 0, false);
    } else if (areaEntityId2 != 0) {
        PlayCutsceneToPlayerAndWarp(cutsceneId2, CutscenePlayMode.SkippableWithFadeOutSkip, areaEntityId2, mapId, 10000, 0, false);
    } else {
        PlayCutsceneToPlayerAndWarp(cutsceneId2, CutscenePlayMode.SkippableWithFadeOutSkip, areaEntityId, mapId, 10000, 0, false);
    }
    WaitFixedTimeRealFrames(1);
...
// 巨大エレベータ起動_禁域_XX -- Giant elevator starts_Forbidden area_XX
$Event(936, Default, function(cutsceneId, cutsceneId2, eventFlagId, mapId, areaEntityId, unknown, shouldChangeWeather, weather, weatherLifespanSeconds) {
    WaitFor(
        !(HasMultiplayerState(MultiplayerState.Multiplayer)
            || HasMultiplayerState(MultiplayerState.MultiplayerPending))
    ...
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(9021, ON);
    PlayCutsceneToPlayerAndWarpWithWeatherAndTime(cutsceneId, CutscenePlayMode.Skippable, areaEntityId, mapId, 10000, unknown, false, shouldChangeWeather, weather, weatherLifespanSeconds, false, 0, 0, 0);
    WaitFixedTimeRealFrames(1);
    PlayCutsceneToPlayer(cutsceneId2, CutscenePlayMode.SkippableWithFadeOutSkip, 10000);
    WaitFixedTimeRealFrames(1);
    RestartEvent();
...
$Event(960, Default, function(eventFlagId) {
    EndIf(EventFlag(951));
    EndIf(EventFlag(eventFlagId));
    WaitFor(EventFlag(951) || EventFlag(eventFlagId));
    EndIf(EventFlag(951));
    IncrementEventValue(955, 3, 7);
});

// 地下地図解放 -- Underground map release
...
// いんちきランダム配置パターン選択 -- Bogus random placement pattern selection
...
// 世界樹の恵み -- Blessings of the World Tree
...
// 疑似誓約_狂い火 -- Pseudo oath_crazy fire
...
// 転送禁止罠解除 -- Removal of transfer prohibition trap
...
// 闘技場マッチング中_転送禁止 -- During arena matching_transfer prohibited
...
// ボス撃破_アイテム取得_XX -- Defeat boss_obtain item_XX
...
// ジェスチャー獲得_黄金律の輪のポーズ -- Gesture acquisition_Golden rule circle pose
...
// ジェスチャー獲得_黄金律の輪のポーズ伝播 -- Gesture acquisition_Golden rule wheel pose propagation
...
// ジェスチャー獲得_開戦の一礼 -- Gesture Acquisition_Start of War Bow
$Event(1410, Restart, function(eventFlagId, commandId, spEffectId, chrEntityId, eventFlagId2) {
    EndIf(!PlayerIsInOwnWorld());
    WaitFor(PlayerIsInOwnWorld() && EventFlag(eventFlagId2));
    RequestCharacterAICommand(chrEntityId, 80, 0);
    RequestCharacterAICommand(chrEntityId, commandId, 1);
    RequestCharacterAIReplan(chrEntityId);
    sp = CharacterHasSpEffect(chrEntityId, spEffectId);
    WaitFor(sp || HasDamageType(chrEntityId, 10000, DamageType.Unspecified));
    RequestCharacterAICommand(chrEntityId, -1, 0);
    RequestCharacterAICommand(chrEntityId, -1, 1);
    RequestCharacterAIReplan(chrEntityId);
    EndIf(!sp.Passed);
    EndIf(EventFlag(eventFlagId));
    AwardGesture(commandId);
    SetEventFlagID(eventFlagId, ON);
});

// ジェスチャー獲得_よっ -- Gesture acquisition_Yo
$Event(1411, Restart, function(eventFlagId, commandId, spEffectId, chrEntityId, eventFlagId2, chrEntityId2, eventFlagId3, chrEntityId3, eventFlagId4) {
    EndIf(!PlayerIsInOwnWorld());
    ...
    if (EventFlag(eventFlagId3)) {
        RequestCharacterAICommand(chrEntityId2, 80, 0);
        RequestCharacterAICommand(chrEntityId2, commandId, 1);
        RequestCharacterAIReplan(chrEntityId2);
    }
    if (EventFlag(eventFlagId4)) {
        RequestCharacterAICommand(chrEntityId3, 80, 0);
        RequestCharacterAICommand(chrEntityId3, commandId, 1);
        RequestCharacterAIReplan(chrEntityId3);
    }
    WaitFor(
        CharacterHasSpEffect(chrEntityId, spEffectId)
            || CharacterHasSpEffect(chrEntityId2, spEffectId)
            || CharacterHasSpEffect(chrEntityId3, spEffectId));
    if (EventFlag(eventFlagId2)) {
        RequestCharacterAICommand(chrEntityId, -1, 0);
        RequestCharacterAICommand(chrEntityId, -1, 1);
        RequestCharacterAIReplan(chrEntityId);
    ...
    if (EventFlag(eventFlagId4)) {
        ...
        RequestCharacterAICommand(chrEntityId3, -1, 1);
        RequestCharacterAIReplan(chrEntityId3);
    }
    EndIf(EventFlag(eventFlagId));
    AwardGesture(commandId);
...
// ジェスチャー獲得_剣に誓って２ -- Gesture acquisition_swear on the sword 2
$Event(1412, Restart, function(eventFlagId, commandId, spEffectId, chrEntityId, eventFlagId2) {
    WaitFor(EventFlag(eventFlagId2) && EntityInRadiusOfEntity(10000, chrEntityId, 18, 1));
    RequestCharacterAICommand(chrEntityId, 80, 0);
    RequestCharacterAICommand(chrEntityId, commandId, 1);
    RequestCharacterAIReplan(chrEntityId);
    sp = CharacterHasSpEffect(chrEntityId, spEffectId);
...
// 種火解禁_XX -- Pilot fire lifted_XX
$Event(1450, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4) {
    DisableNetworkSync();
    onlineFlag &= PlayerIsInOwnWorld() && EventFlag(eventFlagId);
    if (0 != eventFlagId2) {
        onlineFlag &= EventFlag(eventFlagId2);
    }
    if (0 != eventFlagId3) {
        onlineFlag &= EventFlag(eventFlagId3);
    }
    if (0 != eventFlagId4) {
...
// ヒビ壺所持数カウント -- Count the number of crack pots owned
...
// 上位壺所持数カウント -- Count the number of top pots you own
...
// 調香瓶所持数カウント -- Count the number of perfume bottles owned
...
// 地図アイテム_入手演出_XX -- Map item_Obtainment effect_XX
$Event(1600, Default, function(eventFlagId, eventFlagId2, assetEntityId, assetEntityId2) {
    DisableNetworkSync();
    if (!PlayerIsInOwnWorld()) {
        EndIf(0 == assetEntityId);
        WaitFor(AssetBackread(assetEntityId2));
...
// 地図アイテム_沿岸部開放_XX -- Map item_Coastal area opening_XX
$Event(1630, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5, eventFlagId6, eventFlagId7, eventFlagId8, eventFlagId9) {
    EndIf(!PlayerIsInOwnWorld());
    EndIf(EventFlag(eventFlagId));
    onlineFlag &= PlayerIsInOwnWorld() && EventFlag(eventFlagId2);
    if (0 != eventFlagId3) {
        onlineFlag &= EventFlag(eventFlagId3);
    }
    if (0 != eventFlagId4) {
    ...
    if (0 != eventFlagId5) {
        onlineFlag &= EventFlag(eventFlagId5);
    }
    if (0 != eventFlagId6) {
        onlineFlag &= EventFlag(eventFlagId6);
    }
    if (0 != eventFlagId7) {
        onlineFlag &= EventFlag(eventFlagId7);
    }
    if (0 != eventFlagId8) {
        onlineFlag &= EventFlag(eventFlagId8);
    }
    if (0 != eventFlagId9) {
        onlineFlag &= EventFlag(eventFlagId9);
    }
    WaitFor(onlineFlag);
    SetEventFlagID(eventFlagId, ON);
});

// 時止めチュートリアル_死亡復帰 -- Time stop tutorial_Return from death
...
// 時止めチュートリアル_死亡復帰予約 -- Time Stop Tutorial_Death Return Reservation
...
// 時止めチュートリアル_バディ -- Time stop tutorial_buddy
...
// 時止めチュートリアル_クラフト -- Time stop tutorial_craft
...
// 時止めチュートリアル_ヒビ壺 -- Time stop tutorial_crack pot
...
// 時止めチュートリアル_魔石 -- Time stop tutorial_magic stone
...
// 時止めチュートリアル_汎用_XX -- Time stop tutorial_General purpose_XX
$Event(1720, Restart, function(eventFlagId, eventFlagId2, tutorialParamId, itemId) {
    DisableNetworkSync();
    EndIf(!PlayerIsInOwnWorld());
    EndIf(EventFlag(eventFlagId));
    WaitFor(
    ...
    SetEventFlagID(eventFlagId, ON);
    if (Signed(itemId) != 0) {
        DirectlyGivePlayerItem(ItemType.Goods, itemId, eventFlagId2, 1);
    }
});

// 時止めチュートリアル_魔法予約 -- Time stop tutorial_Magic reservation
...
// 時止めチュートリアル_弓予約 -- Time stop tutorial_bow reservation
...
// 時止めチュートリアル_バディ召喚可能範囲予約 -- Timestop tutorial_Buddy summonable range reservation
...
// 一行チュートリアル_汎用_XX -- One line tutorial_General purpose_XX
$Event(1770, Restart, function(eventFlagId, eventFlagId2, tutorialParamId) {
    DisableNetworkSync();
    EndIf(!PlayerIsInOwnWorld());
    EndIf(EventFlag(eventFlagId));
    WaitFor(
...
// 一行チュートリアル_騎乗二段ジャンプ予約 -- One-line tutorial_riding double jump reservation
...
// プレイヤー外見変化_眼 -- Player appearance change_eyes
...
// プレイヤー外見変化_体 -- Player appearance change_body
...
// エリクサー救済対応_XX -- Elixir relief support_XX
$Event(6800, Restart, function(itemId, eventFlagId) {
    EndIf(ThisEventSlot());
    if (PlayerIsInOwnWorld()) {
        if (!PlayerHasItem(ItemType.Goods, itemId) && EventFlag(eventFlagId)) {
            SetEventFlagID(eventFlagId, OFF);
        }
        SetThisEventSlot(ON);
        EndEvent();
...
// 救済対応_漆 -- Relief response_lacquer
...
// 救済対応_捌 -- Relief response_handling
...
// アクティビティ開始_XX -- Activity start_XX
$Event(9360, Restart, function(activityId, eventFlagId, timeSeconds) {
    EndIf(ThisEventSlot());
    WaitFor(PlayerIsInOwnWorld() && EventFlag(eventFlagId));
    WaitFixedTimeSeconds(timeSeconds);
...
// アクティビティ終了_XX -- Activity finished_XX
$Event(9375, Restart, function(activityId, eventFlagId, timeSeconds) {
    EndIf(ThisEventSlot());
    WaitFor(PlayerIsInOwnWorld() && EventFlag(eventFlagId));
    WaitFixedTimeSeconds(timeSeconds);
...
// アクティビティ進行カウント_XX -- Activity progress count_XX
$Event(9390, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5, eventFlagId6) {
    EndIf(ThisEventSlot());
    WaitFor(EventFlag(eventFlagId));
    if (0 != eventFlagId2) {
        if (!EventFlag(eventFlagId2)) {
...
// アイテム使用監視_アイテム入手_XX -- Item usage monitoring_Item acquisition_XX
$Event(9820, Restart, function(eventFlagId, itemLotId, spEffectId) {
    DisableNetworkSync();
    if (0 != eventFlagId) {
        EndIf(EventFlag(eventFlagId));
    }
...
// 魔石所持監視_XX -- Magic stone possession monitoring_XX
$Event(65810, Default, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5, eventFlagId6) {
    if (PlayerIsInOwnWorld()) {
        EndIf(EventFlag(eventFlagId));
...
$Event(65910, Default, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5, eventFlagId6) {
    if (PlayerIsInOwnWorld()) {
        EndIf(EventFlag(eventFlagId));
        onlineFlag &= PlayerIsInOwnWorld();
        flag |= EventFlag(eventFlagId2);
...
// イベントテスト_XX -- Event test_XX
$Event(1910, Default, function(npcThreatLevel, eventFlagId) {
    WaitFor(FieldBattleBGMActive(npcThreatLevel));
    SetEventFlagID(eventFlagId, ON);
    WaitFor(!FieldBattleBGMActive(npcThreatLevel));
    SetEventFlagID(eventFlagId, OFF);
    RestartEvent();
...
// 【18．2末版】小篝火補充数リセット -- [18.2 end version] Small bonfire replenishment number reset
$Event(9910, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    WaitFor(EventFlag(eventFlagId) || CharacterDead(10000));
    SetEventFlagID(eventFlagId, OFF);
...
// ラダーン祭り状態管理 -- Ladhan festival status management
...
// ミケラカットシーン再生 -- Michaela cutscene playback
...
// 篝火点灯監視_オープン緑 -- Bonfire lighting monitoring_open green
...
// 篝火点灯監視_オープン湖 -- Bonfire lighting monitoring_Open lake
...
// 篝火点灯監視_オープン高山 -- Bonfire lighting monitoring_Open Takayama
...
// 篝火点灯監視_オープン平原 -- Bonfire lighting monitoring_Open plains
...
// 篝火点灯監視_オープン雪山 -- Bonfire lighting monitoring_Open snow mountain
...
// 影狼頭アイテム処理 -- Shadow Wolf Head Item Processing
...
// 城主の娘殺害でモーグの誓布を血で染める -- Murdering the castle lord's daughter stains Moog's oath with blood.
...
// ウルフライダーのバディ入手 -- Get Wolf Rider Buddy
...
// ジェスチャー入手_土下座 -- Gesture acquisition_Dogeza
...
// ジェスチャー入手_ひらめいた -- Get gesture _ inspired
...
// NPC322ユリア_夜明けの光の徴デバフ -- NPC322 Yuria_sign of dawn debuff
...
// 暗黒円卓空間キックフラグ操作 -- Dark round table space kick flag operation
...
// 侵入回数カウント_他世界 -- Intrusion count_other world
...
// 侵入回数カウント_自世界 -- Count the number of intrusions_own world
...
// PCの見た目変化_竜餐 -- PC appearance change_Dragon food
...
// NPC313火山館の勧誘者_地図ポイント -- NPC313 Volcano Hall Recruiter_Map Points
$Event(3081, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5, eventFlagId6, eventFlagId7) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
...
// NPC301戦場医師_地図ポイント -- NPC301 Battlefield Doctor_Map Points
$Event(3082, Restart, function(eventFlagId, eventFlagId2, eventFlagId3) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
    SetEventFlagID(eventFlagId3, OFF);
...
// NPC300火山館の女主人_地図ポイント -- NPC300 Volcano Hall Mistress_Map Points
$Event(3083, Restart, function(eventFlagId, eventFlagId2) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
...
// NPC228ウルフライダー_地図ポイント -- NPC228 Wolf Rider_Map Points
$Event(3084, Restart, function(eventFlagId, eventFlagId2, eventFlagId3) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
    SetEventFlagID(eventFlagId3, OFF);
...
// NPC309盗賊の頭_地図ポイント -- NPC309 Thief Head_Map Points
$Event(3085, Restart, function(eventFlagId, eventFlagId2) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
...
// NPC318混沌の宿主_地図ポイント -- NPC318 Host of Chaos_Map Points
$Event(3086, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
    SetEventFlagID(eventFlagId3, OFF);
...
// NPC326火山館最強の騎士_地図ポイント -- NPC326 Volcano Hall Strongest Knight_Map Points
$Event(3087, Restart, function(eventFlagId, eventFlagId2, eventFlagId3) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
    SetEventFlagID(eventFlagId3, OFF);
...
// NPC331ならず者_地図ポイント -- NPC331 Rogue_Map Points
$Event(3088, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
    SetEventFlagID(eventFlagId3, OFF);
...
// ロルドの大昇降機中間地点地図ポイント -- Roldo's Great Elevator Midway Map Point
...
// NPC700話す死体_地図ポイント -- NPC700 Talking Corpse_Map Points
$Event(3090, Restart, function(eventFlagId, eventFlagId2) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
...
// NPC106ラニ_地図ポイント -- NPC106 Rani_Map Point
$Event(3091, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
...
// NPC224爺や_地図ポイント -- NPC224 Old Man_Map Points
$Event(3092, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
...
// NPC307傀儡師_地図ポイント -- NPC307 Puppet Master_Map Points
$Event(3093, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
...
// NPC322ユリア_地図ポイント -- NPC322 Yuria_Map Point
$Event(3094, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
...
// NPC319ダヴィド_地図ポイント -- NPC319 David_Map Point
$Event(3095, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
...
// NPC310城主の娘_地図ポイント -- NPC310 Castle Lord's Daughter_Map Points
$Event(3096, Restart, function(eventFlagId, eventFlagId2) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId2, OFF);
...
// NPC312平原砦の領主_地図ポイント -- NPC312 Lord of Plains Fort_Map Points
$Event(3097, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
...
// NPC312平原砦の領主_セレン殺害までのボス撃破カウント -- NPC312 Lord of Plains Fort_Boss defeat count until Seren is killed
...
// NPC223亜人針子_生まれ変わり会話までのボス撃破カウント -- NPC223 Demi-Shinko_Boss defeat count until reincarnation conversation
...
// NPC302門衛_地図ポイント -- NPC302 Gatekeeper_Map Points
$Event(4600, Restart, function(eventFlagId, eventFlagId2) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    ...
    WaitFor(
        EventFlagState(CHANGE, TargetEventFlagType.EventFlag, 3265)
            ...
            || (EventFlag(10002768) && !EventFlag(eventFlagId2)));
    RestartEvent();
});

// NPC200レナラ_地図ポイント -- NPC200 Renala_Map Points
$Event(4601, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    EndIf(EventFlag(eventFlagId));
    ...
    WaitFor(
        EventFlag(14009205)
            || ((EventFlag(14002705) || EventFlag(14002706)) && !EventFlag(eventFlagId)));
    RestartEvent();
});

// NPC314ムノウ_地図ポイント -- NPC314 Munou_Map Point
$Event(4602, Restart, function(eventFlagId, eventFlagId2, eventFlagId3) {
    EndIf(!PlayerIsInOwnWorld());
...
S1:
    ...
    WaitFor(
        EventFlagState(CHANGE, TargetEventFlagType.EventFlag, 1037449205)
            || (EventFlag(1037442700) && !EventFlag(eventFlagId))
            || EventFlag(3448)
            || EventFlag(3449)
            ...
            || (EventFlag(1039442721) && !EventFlag(eventFlagId3)));
    RestartEvent();
});

// NPC323糞喰い_地図ポイント -- NPC323 Shit-eater_Map points
$Event(4603, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    ...
    WaitFor(
        EventFlagState(CHANGE, TargetEventFlagType.EventFlag, 35009306)
            ...
            || (EventFlag(35002724) && !EventFlag(eventFlagId)));
    RestartEvent();
});

// NPC348_マレニアの娘_地図ポイント -- NPC348_Marenia's Daughter_Map Points
$Event(4604, Restart, function(eventFlagId, eventFlagId2, eventFlagId3) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId2, OFF);
    SetEventFlagID(eventFlagId3, OFF);
    ...
    WaitFor(
        EventFlagState(CHANGE, TargetEventFlagType.EventFlag, 1050389256)
            || (EventFlag(1050382713) && !EventFlag(eventFlagId))
...
// NPC349_腐敗長老_地図ポイント -- NPC349_Corrupt Elder_Map Points
$Event(4606, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
...
// NPC220_壺マイヤー_地図ポイント -- NPC220_Tsubomair_Map Point
$Event(4607, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4) {
    EndIf(!PlayerIsInOwnWorld());
    ...
    WaitFor(
        EventFlagState(CHANGE, TargetEventFlagType.EventFlag, 1043399305)
            || (EventFlag(1043392713) && !EventFlag(eventFlagId))
            ...
            || (EventFlag(1039442703) && !EventFlag(eventFlagId2))
            ...
            || (EventFlag(1035532703) && !EventFlag(eventFlagId3))
...
// NPC226_生きている小壺_地図ポイント -- NPC226_Living pot_Map points
$Event(4608, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
...
// NPC223_亜人針子_地図ポイント -- NPC223_Ajin seamstress_Map points
$Event(4609, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
    SetEventFlagID(eventFlagId3, OFF);
...
// NPC351_金仮面の従者_地図ポイント -- NPC351_Golden Masked Squire_Map Points
$Event(4611, Restart, function(eventFlagId, eventFlagId2) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
...
// 雪山霊廟救済 -- snowy mountain mausoleum relief
...
// NPC100娘マリカ_キャラ状態遷移 -- NPC100 Daughter Marika_Character state transition
...
// NPC213鍛冶屋_拠点_キャラ状態遷移 -- NPC213 Blacksmith_Base_Character state transition
...
// NPC800赤目商人カーレ_キャラ状態遷移 -- NPC800 Red-Eyed Merchant Kaare_Character state transition
...
// NPC801赤目商人モブ_キャラ状態遷移 -- NPC801 Red Eye Merchant Mob_Character state transition
...
// NPC802赤目商人3_キャラ状態遷移 -- NPC802 Red Eye Merchant 3_Character state transition
...
// NPC800旧赤目商人1_キャラ状態遷移 -- NPC800 Old Red-Eyed Merchant 1_Character state transition
...
// NPC8XX赤目商人全体_状態遷移 -- All NPC8XX red-eyed merchants_state transition
...
// NPC220壺マイヤー_キャラ状態遷移 -- NPC220 Tsubo Meyer_Character state transition
...
// NPC301戦場医師_キャラ状態遷移 -- NPC301 Battlefield Doctor_Character state transition
...
// NPC302門衛_キャラ状態遷移 -- NPC302 Gatekeeper_Character state transition
...
// NPC303傭兵剣士_キャラ状態遷移 -- NPC303 Mercenary Swordsman_Character state transition
...
// NPC304傷剣士_キャラ状態遷移 -- NPC304 Wounded Swordsman_Character state transition
$Event(3259, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4) {
    if (!AnyBatchEventFlags(eventFlagId, eventFlagId2)) {
        BatchSetNetworkconnectedEventFlags(eventFlagId, eventFlagId2, OFF);
        SetNetworkconnectedEventFlagID(eventFlagId, ON);
    }
    if (!AnyBatchEventFlags(eventFlagId3, eventFlagId4)) {
...
// NPC300火山館の女主人_キャラ状態遷移 -- NPC300 Volcano Hall Mistress_Character state transition
...
// NPC310城主の娘_キャラ状態遷移 -- NPC310 Castle Lord's Daughter_Character state transition
...
// NPC313火山館の勧誘者_キャラ状態遷移 -- NPC313 Volcano Hall Recruiter_Character state transition
...
// NPC314ムノウ_キャラ状態遷移 -- NPC314 Munou_Character state transition
...
// NPC102指読み_キャラ状態遷移 -- NPC102 finger reading_Character state transition
...
// NPC219足萎え村のNPC_キャラ状態遷移 -- NPC219 NPC in the withered village_Character state transition
...
// NPC318混沌の宿主_キャラ状態遷移 -- NPC318 Host of Chaos_Character state transition
...
// NPC202マリケス_キャラ状態遷移 -- NPC202 Marikes_Character state transition
...
// NPC309盗賊の頭_キャラ状態遷移 -- NPC309 Thief Head_Character state transition
...
// NPC320ファルネーゼ_キャラ状態遷移 -- NPC320 Farnese_Character state transition
...
// NPC337王都老人_キャラ状態遷移 -- NPC337 Royal Capital Old Man_Character state transition
...
// NPC326火山館最強の騎士_キャラ状態遷移 -- NPC326 Volcano Hall Strongest Knight_Character state transition
...
// NPC316学院の女魔術師_キャラ状態遷移 -- NPC316 Academy Female Magician_Character state transition
...
// NPC321見張り塔の貴族_キャラ状態遷移 -- NPC321 Watchtower Noble_Character state transition
...
// NPC333戻れない輝石魔術師_キャラ状態遷移 -- NPC333 Pyroxene magician who cannot return_Character state transition
...
// NPC312平原砦の領主_キャラ状態遷移 -- NPC312 Lord of Plains Fort_Character state transition
...
// NPC330贖罪司祭_キャラ状態遷移 -- NPC330 Atonement Priest_Character state transition
...
// NPC331ならず者_キャラ状態遷移 -- NPC331 Rogue_Character state transition
...
// NPC332火山館の幽霊_キャラ状態遷移 -- NPC332 Ghost of the Volcano Hall_Character state transition
...
// NPC227霊クラゲの少女_キャラ状態遷移 -- NPC227 Spirit Jellyfish Girl_Character state transition
...
// NPC223亜人針子_キャラ状態遷移 -- NPC223 Demi-Shimiko_Character state transition
...
// NPC106ラニ_キャラ状態遷移 -- NPC106 Rani_Character state transition
...
// NPC216狼頭の戦士_キャラ状態遷移 -- NPC216 Wolf-Headed Warrior_Character state transition
...
// NPC307傀儡師_キャラ状態遷移 -- NPC307 Puppeteer_Character state transition
...
// NPC224爺や_キャラ状態遷移 -- NPC224 Grandpa_Character state transition
...
// NPC325ロジェール_キャラ状態遷移 -- NPC325 Roger_Character state transition
...
// NPC322ユリア_キャラ状態遷移 -- NPC322 Yuria_Character state transition
...
// NPC319ダヴィド_キャラ状態遷移 -- NPC319 David_Character state transition
...
// NPC319ダニー_キャラ状態遷移 -- NPC319 Danny_Character state transition
...
// NPC228ウルフライダー_キャラ状態遷移 -- NPC228 Wolf Rider_Character state transition
...
// NPC349腐敗長老_キャラ状態遷移 -- NPC349 Corrupt Elder_Character state transition
...
// NPC348マレニアの娘_キャラ状態遷移 -- NPC348 Marenia's Daughter_Character state transition
...
// NPC324百智卿_キャラ状態遷移 -- NPC324 Lord Hyakuchi_Character state transition
...
// NPC351金仮面の従者_キャラ状態遷移 -- NPC351 Gold Masked Servant_Character state transition
...
// NPC323糞喰い_キャラ状態遷移 -- NPC323 Shit-eater_Character state transition
...
// NPC334百智卿の娘_キャラ状態遷移 -- NPC334 Lord Momochi's daughter_Character state transition
...
// NPC226生きている小壺_キャラ状態遷移 -- NPC226 Living Small Pot_Character state transition
...
$Event(4613, Restart, function(eventFlagId, eventFlagId2) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
...
$Event(4614, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
    SetEventFlagID(eventFlagId3, OFF);
...
$Event(4615, Restart, function(eventFlagId, eventFlagId2) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
...
$Event(4616, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
...
$Event(4617, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
...
$Event(4619, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
...
$Event(4620, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
    SetEventFlagID(eventFlagId3, OFF);
...
$Event(4621, Restart, function(eventFlagId, eventFlagId2) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
...
$Event(4622, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
    SetEventFlagID(eventFlagId3, OFF);
...
$Event(4623, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
    SetEventFlagID(eventFlagId3, OFF);
...
$Event(4624, Restart, function(eventFlagId, eventFlagId2, eventFlagId3) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
    SetEventFlagID(eventFlagId3, OFF);
...
$Event(4625, Restart, function(eventFlagId, eventFlagId2, eventFlagId3) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
    SetEventFlagID(eventFlagId3, OFF);
...
$Event(4626, Restart, function(eventFlagId) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
...
$Event(4627, Restart, function(eventFlagId, eventFlagId2) {
    EndIf(!PlayerIsInOwnWorld());
    SetEventFlagID(eventFlagId, OFF);
    SetEventFlagID(eventFlagId2, OFF);
...
$Event(4841, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5, eventFlagId6, eventFlagId7, eventFlagId8, eventFlagId9, eventFlagId10, eventFlagId11, eventFlagId12, eventFlagId13) {
    EndIf(EventFlag(eventFlagId5));
    WaitFor(EventFlag(eventFlagId2));
    if (!EventFlag(eventFlagId)) {
        BatchSetEventFlags(eventFlagId9, eventFlagId11, OFF);
        if (!AnyBatchEventFlags(eventFlagId6, eventFlagId8)) {
...
L15:
        ...
        GotoIf(L4, EventFlag(eventFlagId7));
        GotoIf(L8, EventFlag(eventFlagId8));
L0:
        BatchSetEventFlags(eventFlagId9, eventFlagId11, OFF);
        if (!EventFlag(eventFlagId13)) {
            if (!EventFlag(eventFlagId12)) {
                ...
                WaitFor(AnyBatchEventFlags(eventFlagId9, eventFlagId11) || time4);
                GotoIf(L19, EventFlag(eventFlagId11));
                GotoIf(L2, EventFlag(eventFlagId10));
                if (!time4) {
                    GotoIf(L1, EventFlag(eventFlagId9));
                }
            }
L1:
            ...
            if (!EventFlag(eventFlagId13)) {
                ...
                WaitFixedTimeSeconds(2);
                WaitFor(
                    AnyBatchEventFlags(eventFlagId9, eventFlagId11)
                        || TimeOfDayInRange(20, 0, 0, 5, 59, 59));
                GotoIf(L2, EventFlag(eventFlagId11));
                GotoIf(L19, EventFlag(eventFlagId10));
...
L2:
        ...
        WaitFor(AnyBatchEventFlags(eventFlagId9, eventFlagId11) || time5);
        Goto(L19);
L4:
        BatchSetEventFlags(eventFlagId9, eventFlagId11, OFF);
        if (!EventFlag(eventFlagId13)) {
            if (!EventFlag(eventFlagId12)) {
                ...
                WaitFor(AnyBatchEventFlags(eventFlagId9, eventFlagId11) || time6);
                GotoIf(L5, time6);
                GotoIf(L5, EventFlag(eventFlagId9));
                GotoIf(L6, EventFlag(eventFlagId10));
                GotoIf(L19, EventFlag(eventFlagId11));
            }
L5:
            SetEventFlagID(eventFlagId12, ON);
            if (!EventFlag(eventFlagId13)) {
                ...
                WaitFor(AnyBatchEventFlags(eventFlagId9, eventFlagId11) || time7);
                GotoIf(L6, EventFlag(eventFlagId10));
                GotoIf(L19, EventFlag(eventFlagId11));
                if (!time7) {
                    GotoIf(L6, EventFlag(eventFlagId9));
                }
            }
        }
L6:
        ...
        WaitFor(
            AnyBatchEventFlags(eventFlagId9, eventFlagId11)
                || TimeOfDayInRange(12, 0, 0, 19, 59, 59));
        Goto(L19);
L8:
        if (!EventFlag(eventFlagId13)) {
            if (!EventFlag(eventFlagId12)) {
                ...
                WaitFor(AnyBatchEventFlags(eventFlagId9, eventFlagId11) || time8);
                GotoIf(L10, EventFlag(eventFlagId10));
                GotoIf(L19, EventFlag(eventFlagId11));
                if (!EventFlag(eventFlagId9)) {
                    GotoIf(L9, time8);
                }
...
L9:
            ...
            if (!EventFlag(eventFlagId13)) {
                ...
                WaitFor(AnyBatchEventFlags(eventFlagId9, eventFlagId11) || time9);
                GotoIf(L10, EventFlag(eventFlagId11));
                GotoIf(L19, EventFlag(eventFlagId10));
                if (!EventFlag(eventFlagId9)) {
                    GotoIf(L10, time9);
                }
...
L10:
        ...
        WaitFixedTimeSeconds(2);
        WaitFor(
            AnyBatchEventFlags(eventFlagId9, eventFlagId11) || TimeOfDayInRange(20, 0, 0, 5, 59, 59));
        Goto(L19);
    }
L19:
    SetEventFlagID(eventFlagId, ON);
    if (!EventFlag(eventFlagId4)) {
        ...
        SetEventFlagID(eventFlagId, OFF);
        SetEventFlagID(eventFlagId4, ON);
        BatchSetEventFlags(eventFlagId6, eventFlagId8, OFF);
        BatchSetEventFlags(eventFlagId12, eventFlagId13, OFF);
        WaitFixedTimeFrames(1);
...
$Event(4842, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5, eventFlagId6, eventFlagId7, eventFlagId8, eventFlagId9, eventFlagId10, eventFlagId11) {
    EndIf(EventFlag(eventFlagId5));
    if (EventFlag(eventFlagId2)) {
        if (EventFlag(eventFlagId3)) {
        ...
        SetEventFlagID(eventFlagId5, ON);
        if (AnyBatchEventFlags(eventFlagId7, eventFlagId8)) {
...
L10:
        WaitFor(EventFlag(eventFlagId) || AnyBatchEventFlags(eventFlagId10, eventFlagId11));
        if (EventFlag(eventFlagId)) {
            SetEventFlagID(eventFlagId2, ON);
...
$Event(4843, Restart, function(eventFlagId, eventFlagId2) {
    EndIf(!PlayerIsInOwnWorld());
    GotoIf(L1, EventFlag(eventFlagId));
    GotoIf(L10, EventFlag(eventFlagId2));
...
$Event(4845, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, entityId, targetDistance, eventFlagId4, eventFlagId5, eventFlagId6, eventFlagId7, entityId2, eventFlagId8, messageId, messageId2) {
    EndIf(!PlayerIsInOwnWorld());
    GotoIf(L1, !EventFlag(eventFlagId) && !EventFlag(eventFlagId3) && EventFlag(eventFlagId2));
    GotoIf(L2, EventFlag(eventFlagId) && !EventFlag(eventFlagId3) && EventFlag(eventFlagId2));
    GotoIf(L3, EventFlag(eventFlagId) && EventFlag(eventFlagId3) && EventFlag(eventFlagId2));
    GotoIf(L4, 
        EventFlag(eventFlagId)
    ...
    EndIf(
        EventFlag(eventFlagId)
            ...
            && EventFlag(eventFlagId5)
            && EventFlag(eventFlagId7));
    if (!(!EventFlag(eventFlagId2) && !EventFlag(eventFlagId6))) {
        WaitFixedTimeFrames(1);
        EndEvent();
L1:
        WaitFor(
        ...
        DisplayGenericDialog(messageId, PromptType.OKCANCEL, NumberofOptions.OneButton, 0, 0);
        SetEventFlagID(eventFlagId3, ON);
        RestartEvent();
L2:
        ...
        RestartEvent();
L3:
        WaitFor(!EventFlag(eventFlagId2) && EventFlag(eventFlagId6));
        RestartEvent();
L4:
        WaitFor(
            (EventFlag(eventFlagId5)
                && !EventFlag(eventFlagId7)
                && (!EntityInRadiusOfEntity(20000, entityId2, targetDistance, 1)
                    || !EventFlag(eventFlagId8)))
                || EventFlag(eventFlagId7));
        EndIf(EventFlag(eventFlagId7));
        DisplayGenericDialog(messageId2, PromptType.OKCANCEL, NumberofOptions.OneButton, 0, 0);
        SetEventFlagID(eventFlagId7, ON);
        Goto(L10);
L5:
        WaitFor(ElapsedSeconds(1));
...
$Event(4846, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5, eventFlagId6) {
    EndIf(!PlayerIsInOwnWorld());
    GotoIf(L10, CountEventFlags(TargetEventFlagType.EventFlag, eventFlagId5, eventFlagId6) == 1);
    Goto(L20);
L10:
    EndIf(!EventFlag(eventFlagId2));
    WaitFor(EventFlag(eventFlagId3));
    ...
    EndEvent();
L20:
    WaitFor(CountEventFlags(TargetEventFlagType.EventFlag, eventFlagId5, eventFlagId6) == 1);
    RestartEvent();
});

$Event(4847, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5, eventFlagId6) {
    EndIf(!PlayerIsInOwnWorld());
    EndIf(!EventFlag(eventFlagId5));
...
$Event(4848, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, itemLotId) {
    EndIf(!PlayerIsInOwnWorld());
    EndIf(EventFlag(eventFlagId));
    EndIf(!EventFlag(eventFlagId2));
    EndIf(!(EventFlag(eventFlagId3) && EventFlag(eventFlagId4)));
...
$Event(4849, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5, eventFlagId6, eventFlagId7, eventFlagId8, eventFlagId9) {
    EndIf(!PlayerIsInOwnWorld());
    WaitFixedTimeFrames(1);
    EndIf(!EventFlag(eventFlagId));
...
L20:
    SetEventFlagID(eventFlagId4, OFF);
    WaitFor(!EventFlag(eventFlagId5) || EventFlag(eventFlagId6) || EventFlag(eventFlagId8));
    RestartEvent();
});

$Event(4850, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5) {
    EndIf(!PlayerIsInOwnWorld());
...
$Event(4851, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5, eventFlagId6, eventFlagId7, eventFlagId8, eventFlagId9, eventFlagId10, eventFlagId11, eventFlagId12, eventFlagId13, eventFlagId14, eventFlagId15, eventFlagId16, eventFlagId17, eventFlagId18, eventFlagId19, eventFlagId20) {
    EndIf(!PlayerIsInOwnWorld());
    GotoIf(S0, !(EventFlag(eventFlagId10) && (EventFlag(4447) || EventFlag(20019258))));
    Goto(L18);
S0:
    EndIf(EventFlag(eventFlagId13));
    GotoIf(S1, !(EventFlag(eventFlagId17) || EventFlag(eventFlagId18)));
    Goto(L19);
S1:
    GotoIf(L1, !EventFlag(eventFlagId3) && !EventFlag(9146));
    GotoIf(L2, !EventFlag(eventFlagId5) && !EventFlag(eventFlagId6) && !EventFlag(eventFlagId7));
    GotoIf(L3, EventFlag(eventFlagId5) && !EventFlag(eventFlagId6) && !EventFlag(eventFlagId7));
    flag = EventFlag(eventFlagId5) && EventFlag(eventFlagId6);
    if (flag2) {
        SetEventFlagID(eventFlagId5, OFF);
    }
    GotoIf(L4, !EventFlag(eventFlagId10) && !EventFlag(eventFlagId12));
    flag2 &= EventFlag(eventFlagId10);
    flag2 &= EventFlag(eventFlagId12) || EventFlag(eventFlagId15);
    GotoIf(L6, flag2);
    Goto(L20);
L1:
    GotoIf(S2, !(EventFlag(eventFlagId) && (EventFlag(eventFlagId2) || EventFlag(eventFlagId6))));
    SetEventFlagID(eventFlagId3, ON);
    Goto(L2);
S2:
    Goto(L20);
L2:
    ...
    RestartEvent();
L3:
    WaitFor(EventFlag(eventFlagId6) || EventFlag(eventFlagId7));
    SetEventFlagID(eventFlagId5, OFF);
    Goto(L20);
L4:
    flag3 = (EventFlag(eventFlagId8) || EventFlag(eventFlagId14))
        && EventFlag(eventFlagId9)
        && EventFlag(4446);
    flag4 = EventFlag(eventFlagId12) && !EventFlag(eventFlagId15);
    if (flag3 || flag4) {
        if (!flag4.Passed) {
...
L5:
    WaitFor(EventFlag(eventFlagId12) && !EventFlag(eventFlagId15));
    SetEventFlagID(eventFlagId13, ON);
    SetEventFlagID(eventFlagId16, ON);
    EndEvent();
L6:
    WaitFor(EventFlag(eventFlagId12) || EventFlag(eventFlagId13));
...
L19:
    if (!EventFlag(eventFlagId13)) {
        ...
        SetEventFlagID(eventFlagId13, ON);
        SetEventFlagID(eventFlagId16, ON);
        SetEventFlagID(eventFlagId19, ON);
        SetEventFlagID(eventFlagId20, ON);
    }
    EndEvent();
L20:
    EndEvent();
...
$Event(4853, Restart, function(eventFlagId, eventFlagId2) {
    EndIf(!PlayerIsInOwnWorld());
    EndIf(EventFlag(eventFlagId2));
    if (EventFlag(eventFlagId)) {
        SetEventFlagID(eventFlagId2, ON);
...
$Event(4854, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, entityId, targetDistance, eventFlagId4, messageId) {
    EndIf(!PlayerIsInOwnWorld());
    WaitFixedTimeFrames(1);
    EndIf(!EventFlag(eventFlagId2));
    WaitFor(
...
$Event(4857, Restart, function(eventFlagId, itemLotId, itemLotId2, eventFlagId2) {
    EndIf(EventFlag(eventFlagId2));
    WaitFor(EventFlag(eventFlagId));
    if (Signed(itemLotId) != 0) {
        AwardItemsIncludingClients(itemLotId);
...
$Event(4858, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, itemLotId) {
    EndIf(!PlayerIsInOwnWorld());
    EndIf(EventFlag(eventFlagId));
...
$Event(4859, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, eventFlagId4, eventFlagId5, eventFlagId6, eventFlagId7) {
    SetEventFlagID(eventFlagId, OFF);
    if ((EventFlag(eventFlagId2)
        && !EventFlag(eventFlagId3)
        && !EventFlag(eventFlagId4)
        && !(EventFlag(eventFlagId5) && EventFlag(eventFlagId6)))
        || (EventFlag(eventFlagId5) && EventFlag(eventFlagId6) && EventFlag(eventFlagId7))) {
        SetEventFlagID(eventFlagId, ON);
    }
    EndEvent();
});

$Event(4930, Restart, function(eventFlagId, eventFlagId2, eventFlagId3, itemLotId, eventFlagId4, eventFlagId5) {
    EndIf(!PlayerIsInOwnWorld());
    EndIf(EventFlag(eventFlagId));
    SetEventFlagID(eventFlagId4, ON);
    WaitFor(EventFlag(eventFlagId2) && !EventFlag(eventFlagId3));
...
$Event(4933, Restart, function(eventFlagId, eventFlagId2, itemId) {
    EndIf(!PlayerIsInOwnWorld());
    EndIf(EventFlag(eventFlagId) && EventFlag(eventFlagId2));
    GotoIf(L0, EventFlag(eventFlagId));
    GotoIf(L1, EventFlag(eventFlagId2));
    GotoIf(L5, PlayerHasItemIncludingBBox(ItemType.Goods, itemId));
    WaitFor(
        EventFlag(eventFlagId)
            || EventFlag(eventFlagId2)
            || PlayerHasItemIncludingBBox(ItemType.Goods, itemId));
    RestartEvent();
L0:
    SetEventFlagID(eventFlagId2, ON);
    EndEvent();
...
// 遺灰_マップ報酬販売解禁同期_XX -- Ashes_Map reward sales lifted synchronous_XX
$Event(60701, Default, function(eventFlagId, eventFlagId2) {
    if (PlayerIsInOwnWorld()) {
        WaitFor(EventFlag(eventFlagId) || EventFlag(eventFlagId2));
        SetEventFlagID(eventFlagId, ON);
        SetEventFlagID(eventFlagId2, ON);
...
// 【NT】なんちゃってマルチ報酬_XX -- [NT] What a multi-reward_XX
$Event(9930, Default, function(eventFlagId, eventFlagId2, gestureParamId) {
    EndIf(!PlayerIsInOwnWorld());
    WaitFor(PlayerIsInOwnWorld() && EventFlag(eventFlagId));
    if (!EventFlag(eventFlagId2)) {
...
// 【4末版】地図入手フラグ対応_XX -- [Fourth edition] Map acquisition flag supported_XX
$Event(9946, Default, function(eventFlagId, eventFlagId2) {
    EndIf(ThisEventSlot());
    WaitFor(EventFlag(eventFlagId2));
    SetEventFlagID(eventFlagId, ON);
});

// 【4末版】地図入手フラグ対応1stAnniversary_XX -- [Fourth edition] Map acquisition flag supported 1stAnniversary_XX
$Event(9950, Default, function(eventFlagId, eventFlagId2) {
    EndIf(EventFlag(eventFlagId));
    WaitFor(EventFlag(eventFlagId));
    SetEventFlagID(eventFlagId2, ON);
});
